...
x = [
    ...
    [15, 12, 2, "S"],
    [19, 16, 4, "S"],
    [11, 3, 1, "C"],[8, 5, 4, "B"],[9, 1, 4, "B"],[9, 11, 4, "C"],[12, 7, 5, "A"],[13, 8, 5, "S"],[16, 9, 9, "B"],[17, 12, 10, "B"],[15, 9, 2, "A"],[13, 8, 1, "S"],[14, 2, 6, "C"],[15, 4, 5, "A"],[12, 3, 4, "C"],[11, 7, 3, "A"],[16, 7, 7, "B"],[17, 17, 9, "S"],[15, 4, 6, "C"],[10, 8, 13, "B"],[13, 8, 5, "B"],[14, 6, 4, "S"],[9, 3, 2, "C"],[19, 7, 3, "S"],[21, 17, 3, "A"],[22, 6, 5, "A"],]

# Code here
for item in x:
    width, height, length, cube_type = item
    print(width, height, length, cube_type)
    a = y.get(cube_type)[0]
    b = y.get(cube_type)[1]